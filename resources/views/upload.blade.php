            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('upload.save')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="text" name="author" id="author" placeholder="Enter uthor" class="form-control">
                        </div>
                        <div class="form-group">
                            <textarea name="info" class="form-control" id="info" placeholder="Some info about the book"></textarea>
                        </div>
                        <div class="form-group">
